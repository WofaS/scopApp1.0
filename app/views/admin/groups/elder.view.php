...
<div class="pagetitle rounded p-0 border-bottom">
   <nav>   
        <label class="fw-bolder badge text-primary"><?=strtoupper('District elders Overview')?></label>
        ...
        <ul class="breadcrumb my-0 py-0">
          ...
          <li class="card-title d-flex">
           ...
           <b class="mx-2 mb-0 text-danger"><?=$resElder['num'] ?? 0?></b>
          </li>
        </ul>
      </nav>
    </div><!-- End Page Title -->
      ...
      <!-- Profile Edit Form -->
        <div class="card-body">
            ...
            <div class="section-header d-flex justify-content-between align-items-center mb-2">
              <h5 class="text-muted"><?=strtoupper(esc('Sampa District - elder'))?></h5>
            </div>      
            <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
              ...
              <thead>
                <tr style="background: lightgray;">
                  ...
                  <th scope="col" data-sortable="" >ACTION<a href="<?=ROOT?>/admin/excel/print_elders"><button class="btn btn-success btn-sm"><i class="bi bi-file-earmark-excel p-0"></i>  Download Excel</button></a></th>
                </tr>
              </thead>
              <tbody>
                ...
                <?php if($row->role_name ==='elder'): $id +=1;?>
