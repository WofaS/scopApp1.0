...
<?php if($action == 'add'):?>
  ...
  <div class="card col-md-5 mx-auto">
    <div class="card-body">
      <h5 class="card-title">New Local position</h5>
      ...
      <form method="post" class="row g-3">
        ...
        <div class="text-center">
          ...
          <a href="<?=ROOT?>/admin/local_position">
...
<?php elseif($action == 'delete'):?>
  ...
  <div class="card col-md-5 mx-auto">
    <div class="card-body">
      <h5 class="card-title">Delete Local position</h5>
...
<?php elseif($action == 'edit'):?>
  ...
  <div class="card col-md-5 mx-auto">
    <div class="card-body">
      <h5 class="card-title">Edit Local position</h5>
...
<?php else:?>
  ...
  <div class="card col-md-8 mx-auto">
    ...
    <div class="card-body">
      <h5 class="card-title">
        Local Positions 
        <a href="<?=ROOT?>/admin/local_position/add">
              ...
              <tbody>
                ...
                <?php foreach($rows as $row): 
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-sm btn-outline-primary" href="<?=ROOT?>/admin/local_position/edit/<?=$row->id?>">
                        <i class="bi bi-pencil-square"></i> 
                      </a>
                      <a class="btn btn-sm btn-outline-danger" href="<?=ROOT?>/admin/local_position/delete/<?=$row->id?>">
