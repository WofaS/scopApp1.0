...
if(!empty($row->category_id) AND $row->role_name === 'elder' OR $row->role_name === 'deacon' OR $row->role_name === 'deaconess'){
 ...
 $id +=1;
    ...
    $Sampa_District_Officers = array_merge($Sampa_District_Officers, array(array($id, $row->firstname, $row->lastname, $row->role_name, $age, get_date($row->dob), $row->email, $row->phone, $row->residence)));
  }
}
