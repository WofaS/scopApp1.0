    ...
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="row mb-3 ">
        ...
        <div class="mx-auto col-md-4 col-lg-5">
          <select class="form-control selectric rounded <?=!empty($errors['gender']) ? 'border-danger':'';?>" name="gender"  >
        ...
        <div class="mx-auto col-md-4 col-lg-4">
          <select class="form-control selectric rounded <?=!empty($errors['marital_status_id']) ? 'border-danger':'';?>" name="marital_status_id"  >
      ...
      <?php if(user_can('edit_slider_images')):?>
        ...
        <div class="mx-auto col-md-3 col-lg-3">
          <select class="form-control selectric rounded <?=!empty($errors['water_baptized']) ? 'border-danger':'';?>" name="water_baptized"  >
        ...
        <div class="mx-auto col-md-3 col-lg-3">
          <select class="form-control selectric rounded <?=!empty($errors['holyghost_baptized']) ? 'border-danger':'';?>" name="holyghost_baptized"  >
        ...
        <div class="mx-auto col-md-3 col-lg-3">
          <select class="form-control selectric rounded <?=!empty($errors['communicant_status']) ? 'border-danger':'';?>" name="communicant_status"  >
      ...
      <?php endif;?>
       ...
       <?php if(user_can('edit_slider_images')):?>
        ...
        <div class="mx-auto col-md-4 col-lg-5">
          <select class="form-control selectric rounded <?=!empty($errors['category_id']) ? 'border-danger':'';?>" name="category_id"  >
        ...
        <div class="mx-auto col-md-4 col-lg-4">
          <select class="form-control selectric rounded <?=!empty($errors['role']) ? 'border-danger':'';?>" name="role"  >
      ...
      <?php endif;?>
          ...
          <div class="row mb-3">
            ...
            <div class="mx-auto col-md-4 col-lg-5">
              <select name="localposition_id" class="form-control selectric rounded">
            ...
            <div class="mx-auto col-md-4 col-lg-4">
              <select name="position_id" class="form-control selectric rounded">
