...
<form>
	<div class="col-md-8 mx-auto">
		...
		<div  class="container-fluid h4 text-primary my-3"><b>Activity Landing page</b></div>

		<div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon1">Activity Title</span>
          <input value="<?=$row->title?>" name="title" type="text" class="form-control" >
          <small class="error error-title w-100 text-danger"></small>
        </div>

		<div class="input-group mb-3">
          <span class="input-group-text text-wrap col-lg-2 col-3" id="basic-addon1">Activity Summary (not more than 50 words)</span>
        ...
        <div class="input-group mb-3">
          <span class="input-group-text text-wrap col-lg-2 col-3 ">Activity Description</span>
        ...
        <div class="my-4 row">
        	...
        	<div class="col-sm-8">
        		<div  class="h5"><b>Activity Image:</b></div>
        ...
        <div class="my-4 row">
        	<div class="col-sm-6">
        		...
        		<video controls class="js-video-upload-preview" style="width: 100%;">
        			<source class="js-video-upload-preview" src="<?=get_video($row->course_promo_video)?>" type="video/mp4">
        		</video>
        	</div>
        	<div class="col-sm-6">
        		<div  class="h5"><b>Activity Video:</b></div>
        		...
        		<br><br>
        		<input onchange="upload_course_promo_video(this.files[0])" class="js-video-upload-input" type="file" name="">
        		<div class="progress my-4">
	            ...
	            <button type="button" onclick="ajax_course_promo_video_cancel()" class="js-video-upload-cancel-button btn btn-warning text-white btn-sm hide">Cancel Upload</button>
        	</div>
        </div>
