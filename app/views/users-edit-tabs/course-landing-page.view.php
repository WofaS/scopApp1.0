<form>
	<div class="col-md-8 mx-auto">
		...
		<div class="input-group mb-3">
          <span class="input-group-text text-wrap col-lg-2 col-3" id="basic-addon1">Course subtitle</span>
        ...
        <div class="input-group mb-3">
          <span class="input-group-text text-wrap col-lg-2 col-3 ">Description</span>
          <textarea  class="form-control" aria-label="With textarea" style="height: 100px;" name="description"><?=$row->description?></textarea>
        ...
        <div class="my-4 row">
        	<div class="col-sm-4">
        		<img class="js-image-upload-preview" src="<?=get_image($row->user_image)?>" style="width: 100%;height: 220px;object-fit: cover;">
        	</div>
        	<div class="col-sm-8">
        		<div  class="h5"><b>Course Image:</b></div>
        		Upload your user image here. It must meet our user image quality standards to be accepted. Important guidelines: 750x422 pixels; .jpg, .jpeg,. gif, or .png. no text on the image.
        	
        		<br><br>
        		<input onchange="upload_user_image(this.files[0])" class="js-image-upload-input" type="file" name="">
	            ...
	            <button type="button" onclick="ajax_user_image_cancel()" class="js-image-upload-cancel-button btn btn-warning text-white btn-sm hide">Cancel Upload</button>
        	</div>
        </div>
        ...
        <div class="my-4 row">
        	<div class="col-sm-6">
        		...
        		<video controls class="js-video-upload-preview" style="width: 100%;">
        			<source src="$row->user_promo_video" type="video/mp4">
        		</video>
        	</div>
        	<div class="col-sm-6">
        		<div  class="h5"><b>Course Video:</b></div>
        		Students who watch a well-made promo video are 5X more likely to enroll in your user. We've seen that statistic go up to 10X for exceptionally awesome videos. Learn how to make yours awesome!
        	
        		<br><br>
        		<input onchange="upload_user_video(this.files[0])" class="js-video-upload-input" type="file" name="">
        		<div class="progress my-4">
	            ...
	            <button type="button" onclick="ajax_user_video_cancel()" class="js-video-upload-cancel-button btn btn-warning text-white btn-sm hide">Cancel Upload</button>
        	</div>
        </div>
