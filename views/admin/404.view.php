  ...
  <main>
    <div class="container">
      ...
      <section class="section error-404 min-vh-100 d-flex flex-column align-items-center justify-content-center">
        ...
        <a class="btn" href="<?=ROOT?>/admin/dashboard">Back to Dashboard</a>
        <img src="<?=ROOT?>/niceadmin/assets/img/not-found.svg" class="img-fluid py-5" alt="Page Not Found">
        <div class="credits">
