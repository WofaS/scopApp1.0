  ...
  <div class="card col-md-5 mx-auto">
    <div class="card-body">
      ...
      <?php if(!empty($row)):?>
        ...
        <?php if(user_can('delete_ministries')):?>
      ...
      <?php else:?>
        <div>That Activity was not found!</div>
      <?php endif;?>
  ...
  <div class="card col-md-5 mx-auto">
    <div class="card-body">
      ...
      <?php if(!empty($row)):?>
        ...
        <?php if(user_can('edit_ministries')):?>
      ...
      <?php else:?>
        <div>That record was not found!</div>
      <?php endif;?>
...
<?php else:?>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <?php if(user_can('view_ministries')):?>
