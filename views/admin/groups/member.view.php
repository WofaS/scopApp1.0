...
<div class="pagetitle rounded p-0 border-bottom">
   <nav>   
        <label class="fw-bolder badge text-primary"><?=strtoupper('District members Overview')?></label>
        ...
        <ul class="breadcrumb my-0 py-0">
          ...
          <li class="card-title d-flex">
           ...
           <b class="mx-2 mb-0 text-danger"><?=$resmember['num'] ?? 0?></b>
          </li>
        </ul>
      </nav>
    </div><!-- End Page Title -->
      ...
      <!-- Profile Edit Form -->
        <div class="card-body">
            ...
            <div class="section-header d-flex justify-content-between align-items-center mb-2">
              <h5 class="text-muted"><?=strtoupper(esc('Sampa District - members'))?></h5>
              <p class="col-6">Note: <span class="fst-italic">These are members who are neither children nor officers but have been baptized and attend Lord's supper</span></p>
            </div>      
            <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
              
              <div class="dataTable-container">

              <table class="table table-striped table-borderless table-sm border-bottom table-hover datatable dataTable-loading" >
              <thead>
                <tr style="background: lightgray;">
                  ...
                  <th scope="col" data-sortable="" >ACTION
                    <a href="<?=ROOT?>/admin/excel/print_membersOnly"><button class="btn btn-success btn-sm"><i class="bi bi-file-earmark-excel p-0"></i>  Download Excel</button></a>
                  </th>
                </tr>
              </thead>
              <tbody>
                ...
                <?php if($row->role_name ==='member'): $id +=1;?>
