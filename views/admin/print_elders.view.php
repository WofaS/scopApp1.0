...
if(!empty($row->category_id) AND $row->role_name === 'elder'){
 ...
 $id +=1;
    ...
    $Sampa_District_Elders = array_merge($Sampa_District_Elders, array(array($id, $row->firstname, $row->lastname, $row->role_name, $age, get_date($row->dob), $row->email, $row->phone, $row->residence)));
  }
}
